...
describe('ServiceRegistry', () => {
	...
	describe('new', () => {
		it('should accept a timout being passed in', () => {
			const serviceRegistry = new ServiceRegistry(42);
			serviceRegistry._timetout.should.equal(42);
		});
	});
	...
	describe('remove', () => {
		it('should remove a service from registy', () => {
			const serviceRegistry = new ServiceRegistry(30);
			serviceRegistry.add('test', '127.0.0.1', 9999);
	...
	describe('_cleanup', () => {
		it('should clean  a service from registy', () => {
